...
public class MyApplication extends Application {
	...
	public void onCreate() {
       ...
       CMAdManagerFactory.setImageDownloadListener(new MyImageLoadListener());
        ...
        CMAdManager.getFactory().addLoaderClass("bd", "com.cmcm.adsdk.adapter.BaiduNativeAdapter");
        CMAdManager.getFactory().addLoaderClass("gdt", "com.cmcm.adsdk.adapter.GDTNativeAdapter");
    }
